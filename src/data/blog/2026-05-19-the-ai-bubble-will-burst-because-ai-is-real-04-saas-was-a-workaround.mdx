...
Part 3 argued that the durable moat in AI is unlikely to sit neatly inside the model API. This chapter shifts the lens to application software and asks what happens when the economics that made SaaS dominant begin to change, before the company-form consequences become explicit in [Part 5](/posts/the-ai-bubble-will-burst-because-ai-is-real-05-ai-operated-company).
...
In [Part 5](/posts/the-ai-bubble-will-burst-because-ai-is-real-05-ai-operated-company), I take that repricing logic one step further and ask what happens when the company itself starts becoming software.
